<aside class="sidebar">
    <header class="sidebar-header">
        <h3 class="ms-2">Instavel</h3>
    </header>
    <nav>
        <a href="{{ route('home') }}">
            <span>
                <svg aria-label="" class="" color="#262626" fill="#262626" height="24" role="img"
        ...
        <a>
            <span>
                <svg aria-label="Messenger" class="" color="#262626" fill="#262626" height="24" role="img"
                    viewBox="0 0 24 24" width="24">
                    <path
                        ...
                        <div class="">
                            <div class=""><span class="" role="link" tabindex="-1"
                                    style="width: 24px; height: 24px; border-radius: 50%;"><img
                                        style="border-radius: 50%; width: 23px; height: 23px;" alt=""
                                        class="profile-img" crossorigin="anonymous" draggable="false"
                                        src="{{ route('avatar', ['filename' => Auth::user()->image]) }}"></span>
                            </div>
                        </div>
                    </div>
        ...
        <a role="button" class="btn-group dropup">
